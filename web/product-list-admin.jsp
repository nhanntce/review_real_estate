<%-- 
    ...
    Created on : Nov 4, 2019, 9:14:54 PM
    Author     : NhanNT
--%>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button onclick="location.href = 'product-edit-admin.jsp?page=<%=p%>&s=<%=search%>&id=<%=product.getIdProduct()%>'"><i class="fa fa-pencil text-warning"></i></button>
                            <button onclick="if (confirm('Are you sure delete this product?'))
                                        location.href = 'product-delete-admin.jsp?page=<%=p%>&s=<%=search%>&id=<%=product.getIdProduct()%>'"><i class="fa fa-trash-o text-danger"></i></button>
                            <button onclick="location.href = 'product-detail-admin.jsp?page=<%=p%>&s=<%=search%>&id=<%=product.getIdProduct()%>'"><i class="fa fa-info-circle text-success"></i></button>
                    ...
                    %>
                    <tr>
                        <td colspan="10" align="rigth"> <%=pm.getPagingString(p, search, scl)%></td>
                    </tr>
