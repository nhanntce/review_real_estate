...
public final class product_002ddetail_002dclient_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    ArrayList<Product> productSameTypes = pm.getProductByDistrict(product.getIdDistrict());
      ...
      out.write("            <!--<img src=\"images/product/hero_bg_2.jpg\" style=\"width:100%;\">-->\n");
      out.write("\n");
      ...
      out.write("                                        <img src=\"images/home/slide-1.jpg\" class=\"d-block w-100\" alt=\"\">\n");
      out.write("                                    </div>\n");
      ...
      out.write("                                    <a href=\"product-detail-detail-client.jsp?page=");
      out.print(p);
      out.write("&d=");
      out.print(district);
      out.write("&pf=");
      ...
      out.write("\n");
      out.write("                <form class=\"contact-form\" name=\"myForm\" id=\"myForm\" onsubmit=\"return validation()\" action=\"Customer-new-save-detail.jsp?page=");
      out.print(p);
      out.write("&d=");
      out.print(district);
      out.write("&pf=");
      ...
      out.write("                var phoneCheck = /((09|03|07|08|05)+[0-9]{8})$/i.test(phone.value);\n");
      out.write("//                        var nameCheck = name.length >= 5 && name.length <= 99;\n");
      out.write("                var emailCheck = /^(([^<>()[\\]\\\\.,;:\\s@\\\"]+(\\.[^<>()[\\]\\\\.,;:\\s@\\\"]+)*)|(\\\".+\\\"))@((\\[[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\])|(([a-zA-Z\\-0-9]+\\.)+[a-zA-Z]{2,}))$/i.test(email.value);\n");
      out.write("                var dobCheck = /^[0-9]{1,2}[/]{1}[0-9]{1,2}[/]{1}[0-9]{4}$/g.test(dob.value);\n");
      out.write("                console.log(phoneCheck);\n");
      out.write("                console.log(dobCheck);\n");
      out.write("                console.log(emailCheck);\n");
      out.write("\n");
      out.write("                if (!phoneCheck || !emailCheck || !dobCheck) {\n");
      out.write("                    if (!phoneCheck)\n");
      out.write("                        phoneErr.innerHTML = \"Phone invalid!\";\n");
      out.write("//                            if (!nameCheck)\n");
      out.write("//                                nameErr.innerHTML = \"Name must be greater than 5 or smaller than 99 character!\";\n");
      out.write("                    if (!emailCheck)\n");
      out.write("                        emailErr.innerHTML = \"Mail invalid!\";\n");
      out.write("                    if (!dobCheck)\n");
      out.write("                        dobErr.innerHTML = \"DOB must be format('DD/MM/YYYY')!\";\n");
      out.write("                    return false;\n");
      out.write("                }\n");
      out.write("            }\n");
      out.write("        </script>\n");
